...
cuatro límites acompañan a los hallazgos. La dirección de cada variable se
...
pero con poca potencia. Y el modelo multiclase que respalda la cercanía
entre ``entra'' y ``sale'' se reporta solo de forma resumida, sin describir
su especificación en la Sección~\ref{subsec:modelos}. La lectura que

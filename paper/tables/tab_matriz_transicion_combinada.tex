\begin{table}[H]
  ...
  \begin{minipage}{0.95\textwidth}
    ...
    2013, 2016, generados por \texttt{src/tabla\_matriz\_transicion\_combinada.py}
    sobre \texttt{outputs/tables/pobreza/transicion\_\{pct,conteo\}\_\{,ipm\_\}ola*.csv}
    (\texttt{src/04\_features/build\_pobreza\_desagregaciones.py},
    \texttt{build\_matriz\_transicion\_ipm.py}).
  \end{minipage}
\end{table}
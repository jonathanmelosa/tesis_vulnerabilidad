\begin{table}[H]
  \centering
  \caption{Perfil por grupo de transición, pobreza monetaria (2010$\to$2013), las 53 variables robustas. $^{\dagger}$variable donde el hogar vulnerable no queda entre ``sale'' y ``siempre pobre''/``nunca pobre'' como el resto (ver texto).}
  \label{tab:perfil_consolidada}
  \scriptsize
  \setlength{\tabcolsep}{3pt}
  \begin{minipage}[t]{0.49\textwidth}
    \resizebox{\linewidth}{!}{%
    \begin{tabular}{p{0.62\linewidth}rrrr}
      \toprule
        \textbf{Variable} & \textbf{Siempre} & \textbf{Sale} & \textbf{Entra} & \textbf{Nunca} \\
      \midrule
        \addlinespace\multicolumn{5}{l}{\textbf{Educación y empleo del jefe}} \\
  ...
  \begin{minipage}[t]{0.49\textwidth}
    ...
    \begin{tabular}{p{0.62\linewidth}rrrr}
      ...
      \midrule
        ...
        \addlinespace\multicolumn{5}{l}{\textbf{Programas sociales y deuda}} \\
        ...
        \addlinespace\multicolumn{5}{l}{\textbf{Comunidad}} \\

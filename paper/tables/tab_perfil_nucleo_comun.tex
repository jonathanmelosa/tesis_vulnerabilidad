\begin{table}[H]
  ...
  \newsavebox{\nucleoBoxB}
  \sbox{\nucleoBoxA}{%
    \begin{tabular}{p{0.3038\textwidth}rrrr}
      \toprule
  ...
  \sbox{\nucleoBoxB}{%
    \begin{tabular}{p{0.3038\textwidth}rrrr}
      ...
      \bottomrule
    \end{tabular}}
  % Ambas mitades se escalan por el MISMO factor (regla de tres sobre el
  % ancho natural mayor de las dos), en vez de dos \resizebox
  % independientes -- que, al normalizar cada una a 0.49\textwidth por
  % separado, producían factores de escala ligeramente distintos (una de
  % las dos quedaba perceptiblemente más grande).
  \newlength{\nucleoTarget}
